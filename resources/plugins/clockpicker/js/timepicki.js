	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='previo action-prev'></div>" :
				"<div class='previo action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='nextio action-next'></div>" :
				"<div class='nextio action-prev'></div>";
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'nextio') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prev')) || direction === 'previo') {
